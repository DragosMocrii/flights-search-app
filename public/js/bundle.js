...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 5, 2, 72);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "name", "pass");
    			attr_dev(input1, "placeholder", "Password");
    			add_location(input1, file, 6, 2, 130);
    			add_location(button, file, 7, 2, 193);
    			add_location(div, file, 4, 0, 64);
    			attr_dev(a, "href", "/signup");
    			add_location(a, file, 10, 0, 225);
    		},
    		l: function claim(nodes) {
    ...
    /* src/routes/Signup.svelte generated by Svelte v3.16.4 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "name", "email");
    			attr_dev(input0, "placeholder", "Email");
    			add_location(input0, file$1, 5, 2, 72);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "name", "password");
    			attr_dev(input1, "placeholder", "Password");
    			add_location(input1, file$1, 6, 2, 130);
    			add_location(button, file$1, 7, 2, 197);
    			add_location(div, file$1, 4, 0, 64);
    			attr_dev(a, "href", "/login");
    			add_location(a, file$1, 10, 0, 230);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 7, 0, 356);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$3, 8, 0, 278);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
